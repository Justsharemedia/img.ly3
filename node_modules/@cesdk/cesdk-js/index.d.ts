 ...
 */
declare type BuilderRenderFunction = (context: BuilderRenderFunctionContext) => void;

declare interface BuilderRenderFunctionContext {
    builder: Builder;
...
declare namespace ConfigTypes {
    export {
        ...
        _RequiredCreateConfiguration as CreateConfiguration,
        Theme,
        Scale,
        I18n,
        A11y,
 ...
 * @public
 */
export declare type CreateConfiguration = Partial<_RequiredCreateConfiguration>;
...
declare class CreativeEditorSDK {
     ...
     * `base_url` defaults to 'https://cdn.img.ly/assets/v2'.
     ...
     *
     * @param baseURL - The source of the asset definitions, must be absolute. Defaults to `'https://cdn.img.ly/assets/v2'`.
     ...
     *
     * @deprecated Please use the VariableAPI at `engine.variable` instead.
     */
    ...
    /**
     * Add a plugin to the editor. If a plugin URL is provided, the plugin will be
     ...
     * - `initializeUserInterface` - Called once when the plugin is added to the editor
     *
     * PLEASE NOTE: Plugins provided without URL will not be executed in the worker, e.g.
     ...
     */
    unstable_addPlugin(plugin: EditorPlugin & {
        url?: string;
    }): Promise<void>;
    /**
     ...
     *
     * @returns a promise which resolves after the engine is ready to receive
     * further commands on the CreativeEditorSDK instance
     *
     * @deprecated The `init()` method is deprecated and will be removed in the
     * future.  Please use `CreativeEditorSDK.create()` instead. It allows for
     * more precise control over the initialization process.
     */
     ...
     */
    static create(container: HTMLDivElement | string, config?: CreateConfiguration): Promise<CreativeEditorSDK>;
}
...
export declare class CreativeEngine {
     ...
     */
    addDefaultAssetSources({ baseURL, excludeAssetSourceIds }?: {
        /** The source of the asset definitions, must be absolute. Defaults to `'https://cdn.img.ly/assets/v2'`. */
        baseURL?: string;
 ...
 * @public
 */
declare type DefaultAssetSourceId = 'ly.img.sticker' | 'ly.img.vectorpath' | 'ly.img.colors.defaultPalette' | 'ly.img.filter.lut' | 'ly.img.filter.duotone' | 'ly.img.effect' | 'ly.img.blur';

/**
 * @public
 */
declare type DemoAssetSourceId = 'ly.img.template' | 'ly.img.image.upload' | 'ly.img.video.upload' | 'ly.img.audio.upload' | 'ly.img.image' | 'ly.img.video' | 'ly.img.audio';
...
export declare interface EditorPlugin {
    initializeUserInterface?: (context: EditorPluginContext) => void;
}

declare type EditorPluginContext = {
 ...
 * @public
 */
export declare namespace _EngineConfigTypes {
    /**
...
/** @public */
declare interface EnginePlugin {
...
declare class FeatureAPI {
     ...
     * be replaced or even removed completely in future versions.
     */
    unstable_enable(featureId: string, predicate: FeaturePredicate): void;
    /**
     * TBD
     *
     * Please be aware that this is experimental right now. This API can change or
     * be replaced or even removed completely in future versions.
     */
    unstable_isEnabled(featureId: string, context: IsEnabledFeatureContext): boolean;
}
...
/** @public */
export declare interface _RequiredConfiguration extends Omit<_EngineConfiguration, 'defaultFont' | 'callbacks' | 'presets'> {
    /**
     * @deprecated The configuration option `initialSceneMode` will be removed.
     * Instead of `CreativeEditorSDK.init`, use `CreativeEditorSDK.create`.
     * Configure the SDK using the API, then call `cesdk.createDesignScene()` or
     * `cesdk.engine.scene.createVideo()` instead.
     */
    initialSceneMode?: SceneMode;
    /**
     * @deprecated The configuration option `initialSceneString` will be removed.
     * Instead of `CreativeEditorSDK.init`, use `CreativeEditorSDK.create`.
     * Configure the SDK using the API, then call
     * `cesdk.engine.scene.loadFromString()` to load a scene instead.
     */
    initialSceneString?: string;
    /**
     * @deprecated The configuration option `initialImageURL` will be removed.
     * Instead of `CreativeEditorSDK.init`, use `CreativeEditorSDK.create`.
     * Configure the SDK using the API, then call
     * `cesdk.engine.scene.loadFromURL()` to load a scene instead.
     */
    initialSceneURL?: string;
    /**
     * @deprecated The configuration option `initialImageURL` will be removed.
     * Instead of `CreativeEditorSDK.init`, use `CreativeEditorSDK.create`.
     * Configure the SDK using the API, then call `cesdk.createFromImage()` or
     * `cesdk.engine.scene.createFromImage()` instead.
     */
    ...
    i18n: I18n;
    a11y: A11y;
    callbacks: _EngineConfiguration['callbacks'] & Callbacks;
    /**
    ...
    presets: Omit<_EngineConfiguration['presets'], 'pageFormats' | 'colorPalettes'> & {
        ...
        /**
         * @deprecated The configuration options `presets.pageFormats` has been moved to `ui.pageFormats`.
         */
        pageFormats?: {
            [id: string]: _EngineConfigTypes.PageFormatDefinition | PageFormatDefinition;
        };
    };
}

/**
 * The configuration options for the `CreativeEditorSDK.create` method.
 * The options that have been deprecated in `init` are not available here.
 * @public
 *
 * @privateRemarks
 * Once the Config migration has been live for long enough, we can remove the
 * deprecated options and merge the types back together into a single type.
 */
...
export declare type TypefaceDefinition = {
    ...
    meta?: _EngineConfigTypes.Preset['meta'];
    family: string;
    fonts: {
        fontURL: string;
        weight: FontWeight;
...
declare class UserInterfaceAPI {
     ...
     * be replaced or even removed completely in future versions.
     */
    unstable_registerComponent(id: string, renderComponent: BuilderRenderFunction): void;
    /**
     ...
     *
     * Right now this only returns the custom canvas menu components that are
     * prepend to the canvas menu. This behaviour will very likely change soon
     * and this method will get all canvas menu components.
     *
     * Please be aware that this is experimental right now. This API can change or
     * be replaced or even removed completely in future versions.
     */
    unstable_setCanvasMenuOrder(canvasMenuOrder: string[]): void;
    /**
     ...
     * registered in `unstable_registerComponent`.
     *
     * Right now this only sets the custom canvas menu components that are
     * prepend to the canvas menu. This behaviour will very likely change soon
     * and this method will set all canvas menu components.
     *
     * Please be aware that this is experimental right now. This API can change or
     * be replaced or even removed completely in future versions.
     */
    unstable_getCanvasMenuOrder(): string[];
    /**
