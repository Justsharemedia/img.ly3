/* esbuild-sass-plugin:css-chunk:../../packages/ubq-uikit-web/src/themes/index.scss */
.ubq-dark {
  --ubq-elevation-3: hsl(210, 4%, 25%);
  --ubq-elevation-2: hsl(210, 7.5%, 20%);
  --ubq-elevation-1: hsl(210, 15%, 15%);
  --ubq-canvas: hsl(210, 30%, 10%);
  ...
  --ubq-input-hover:
    linear-gradient(
      ...
      hsla(0, 0%, 0%, 0) ),
    hsla(0, 0%, 0%, 0.4);
  --ubq-interactive-group-default: hsla(0, 0%, 100%, 0);
  --ubq-interactive-group-hover: hsla(0, 0%, 100%, 0.04);
  --ubq-interactive-group-active-default: hsla(0, 0%, 100%, 0.08);
  --ubq-interactive-group-active-hover: hsla(0, 0%, 100%, 0.12);
  --ubq-progress: hsla(210, 0%, 100%, 0.7);
  --ubq-border-default: hsla(0, 0%, 100%, 0.16);
  --ubq-stroke-contrast-1: hsla(0, 0%, 100%, 0.12);
  --ubq-stroke-contrast-2: hsla(0, 0%, 100%, 0.25);
  --ubq-stroke-contrast-3: hsla(0, 0%, 100%, 0.9);
  --ubq-focus-default: hsl(230, 90%, 80%);
  --ubq-focus-outline: hsl(210, 30%, 10%);
  --ubq-overlay: hsla(210, 30%, 10%, 0.8);
  --ubq-notice-info: hsla(0, 0%, 100%, 1);
  --ubq-notice-success: hsla(166, 90%, 37%, 1);
  --ubq-notice-warning: hsla(40, 100%, 60%, 1);
  --ubq-notice-error: hsla(338, 64%, 62%, 1);
  ...
  --ubq-effect-focus:
    ...
    0px 0px 0px 2px var(--ubq-focus-outline),
    0px 0px 0px 4px var(--ubq-focus-default);
}
.ubq-light {
  --ubq-elevation-3: hsl(210, 16%, 96%);
  --ubq-elevation-2: hsl(210, 16%, 93%);
  --ubq-elevation-1: hsl(210, 16%, 90%);
  --ubq-canvas: hsl(210, 16%, 86%);
  --ubq-foreground-default: hsla(210, 30%, 10%, 0.9);
  --ubq-foreground-light: hsla(210, 30%, 10%, 0.7);
  --ubq-foreground-info: hsla(210, 30%, 10%, 0.5);
  --ubq-foreground-active: hsla(210, 0%, 100%, 0.9);
  --ubq-foreground-accent: hsla(210, 0%, 100%, 1);
  --ubq-foreground-danger: hsla(210, 0%, 100%, 1);
  --ubq-interactive-default:
    linear-gradient(
  ...
  --ubq-interactive-hover:
    linear-gradient(
      ...
      hsla(0, 0%, 100%, 0) ),
    hsla(0, 0%, 100%, 0.4);
  --ubq-interactive-pressed: hsla(0, 0%, 100%, 0.4);
  --ubq-interactive-selected:
    linear-gradient(
  ...
  --ubq-interactive-active-hover:
    linear-gradient(
      ...
      hsla(0, 0%, 100%, 0) ),
    hsla(210, 60%, 5%, 0.65);
  --ubq-interactive-active-pressed: hsla(210, 60%, 5%, 0.65);
  --ubq-interactive-accent-default:
    linear-gradient(
  ...
  --ubq-interactive-accent-hover:
    linear-gradient(
      ...
      hsla(0, 0%, 100%, 0) ),
    hsla(230, 90%, 60%, 0.9);
  --ubq-interactive-accent-pressed: hsla(230, 90%, 60%, 0.9);
  --ubq-interactive-danger-default:
    linear-gradient(
  ...
  --ubq-interactive-danger-hover:
    linear-gradient(
      ...
      hsla(0, 0%, 100%, 0) ),
    hsla(338, 64%, 51%, 0.65);
  --ubq-interactive-danger-pressed: hsla(338, 64%, 51%, 0.65);
  --ubq-interactive-template-default:
    linear-gradient(
  ...
  --ubq-interactive-template-hover:
    linear-gradient(
      ...
      hsla(0, 0%, 100%, 0) ),
    hsla(274, 97%, 50%, 0.45);
  --ubq-interactive-template-pressed: hsla(274, 97%, 50%, 0.45);
  --ubq-input-default:
    linear-gradient(
  ...
  --ubq-input-hover:
    linear-gradient(
      ...
      hsla(0, 0%, 0%, 0) ),
    hsla(0, 0%, 0%, 0.08);
  --ubq-interactive-group-default: hsla(208, 29%, 10%, 0);
  --ubq-interactive-group-hover: hsla(208, 29%, 10%, 0.04);
  --ubq-interactive-group-active-default: hsla(208, 29%, 10%, 0.08);
  --ubq-interactive-group-active-hover: hsla(208, 29%, 10%, 0.12);
  --ubq-progress: hsla(210, 30%, 10%, 0.7);
  --ubq-border-default: hsla(210, 0%, 100%, 0.4);
  --ubq-stroke-contrast-1: hsla(210, 30%, 10%, 0.12);
  --ubq-stroke-contrast-2: hsla(210, 30%, 10%, 0.25);
  --ubq-stroke-contrast-3: hsla(210, 30%, 10%, 0.9);
  --ubq-focus-default: hsl(230, 100%, 60%);
  --ubq-focus-outline: hsl(210, 10%, 85%);
  --ubq-overlay: hsla(210, 10%, 85%, 0.8);
  --ubq-notice-info: hsla(210, 30%, 10%, 1);
  --ubq-notice-success: hsla(166, 90%, 37%, 1);
  --ubq-notice-warning: hsla(40, 100%, 37%, 1);
  --ubq-notice-error: hsla(338, 64%, 51%, 1);
  --ubq-effect-shadow: 0px 1px 2px 0px hsla(0, 0%, 0%, 0.16), 0px 0px 0px 0.5px hsla(0, 0%, 0%, 0.08);
  --ubq-effect-focus:
    0px 1px 2px 0px hsla(0, 0%, 0%, 0.16),
    0px 0px 0px 0.5px hsla(0, 0%, 0%, 0.08),
...
.ubq-large {
  ...
  --ubq-typography-input-m-font_family: var( --ubq-typography-font_family, "Inter", sans-serif );
  --ubq-typography-input-m-size: 15px;
  --ubq-typography-input-m-weight: normal;
  --ubq-typography-input-m-letter_spacing: 0.02em;
